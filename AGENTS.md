...
> **Ο έλεγχος πριν πιάσω δουλειά — μηχανικός ρεφλέξ, κάθε φορά:** το πρώτο ένστικτο «το κάνω εγώ τώρα inline» είναι συχνά λάθος. Πριν γράψω κώδικα/χτίσω κάτι, ρωτώ **δύο**: **(1)** είναι code >~40γρ./multi-file; → **delegate** (§ Delegation). **(2)** θέλει επανάληψη μέχρι να περάσει ένα μηχανικό gate (δοκιμές/παραλλαγές/audit-μέχρι-πράσινο); → **loop** (§ Ο βρόχος). Αν καμία: το κάνω εγώ. **Αυτό δεν είναι εξαίρεση — είναι ο κανόνας.** Οι worker/loop είναι τα χέρια μου, όχι έσχατη λύση· τα φτάνω συχνά, όχι σπάνια.
